...
module.exports = async function handler(req, res) {
  ...
  if (req.method === 'PUT') {
    ...
    data.chats[id].messages.push({ id: 'msg-' + Date.now(), senderId: 'system', senderName: 'Tang Hospitality Service', senderRole: 'admin', text: 'Your order status has been updated to: ' + status, timestamp: new Date().toISOString() });
